...
class Product(db.Model):
  ...
  product_id_kraken = db.Column(db.Integer, nullable= False)
...
class Transactions(db.Model):
  ...
  trx_id_kraken = db.Column(db.Integer, nullable = False, default= 0)
  user_id = db.Column(db.Integer, db.ForeignKey('users.id', ondelete='CASCADE'), nullable= False)
  provider =db.Column(db.String(10), nullable = False, default= None)
  phone_number =db.Column(db.String(13), nullable = False)
  label = db.Column(db.String(100), nullable = False , default= None)
...
class Timedetails(db.Model):
  ...
  id = db.Column(db.Integer, primary_key = True, autoincrement = True)
  time_trxid = db.Column(db.Integer, db.ForeignKey('transactions.id', ondelete='CASCADE'), nullable= False)
  time_userid = db.Column(db.Integer, db.ForeignKey('users.id'), nullable= False)
